...
namespace CZY.SlackToolBox.LuckyControl.ColorPicker.ColorModels.HSB
{
    class Brightness:NormalComponent 
    {
            ...
            unsafe
            {
                ...
                for (int iRow = 0; iRow < bitmap.PixelHeight; iRow++)
                {
                    ...
                    for (int iCol = 0; iCol < bitmap.PixelWidth; iCol++)
                    {
                        ...
                        currentPixel++;
                        *(pStart + currentPixel * 3 + 0) = System.Convert.ToByte(g * 255); //Blue
                        *(pStart + currentPixel * 3 + 1) = System.Convert.ToByte(b * 255); //Green 
                        *(pStart + currentPixel * 3 + 2) = System.Convert.ToByte(r * 255); //red
        ...
        {
            int x = System.Convert.ToInt32(sModel.HComponent(color) /359 * 255);
            int y = 255 - System.Convert.ToInt32(sModel.SComponent(color) * 255);
        ...
        public override int Value(Color color)
        {
            ...
            int b = System.Convert.ToInt32(max*100/255 ) ;
            return b;
        }
