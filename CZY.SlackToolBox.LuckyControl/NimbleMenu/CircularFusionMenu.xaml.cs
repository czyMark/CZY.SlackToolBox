...
{
    /// <summary>
    /// CircularFusionMenu.xaml 的交互逻辑
    /// </summary>
    public partial class CircularFusionMenu : UserControl
    {
        public CircularFusionMenu()
        {
            InitializeComponent(); 
        }
        ...
        public static readonly RoutedEvent ClickRoutedEvent =
            EventManager.RegisterRoutedEvent("Click", RoutingStrategy.Bubble, typeof(EventHandler<CircularFusionMenuEventArgs>), typeof(CircularFusionMenu));
        //CLR事件包装
        ...
        {
            if (sender != null && sender.GetType() == typeof(CircularFusionMenu))
            {
                CircularFusionMenu uc = (CircularFusionMenu)sender;
                uc.Init();
        ...
        {
            CircularFusionMenuEventArgs args = new CircularFusionMenuEventArgs(ClickRoutedEvent, this);
            args.Index = -1;
            RaiseEvent(args);
        }
        ...
        private Button GetItemButton(IList<object> itemsSource, int i)
        {
            Button btn = new Button()
            {
                ...
                Style = Resources["CircularFusionMenuItemButtonStyle"] as Style
            };
        ...
        /// 自定义事件参数类
        /// </summary>
        public class CircularFusionMenuEventArgs : RoutedEventArgs
        {
            public CircularFusionMenuEventArgs(RoutedEvent routedEvent, object source) : base(routedEvent, source) { }
