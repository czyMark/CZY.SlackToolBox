...
{
    public class ElementPosition : FrameworkElement
    {
        public static readonly DependencyProperty IsLeftToRightProperty =
            DependencyProperty.Register(nameof(IsLeftToRight), typeof(bool), typeof(ElementPosition));

        public static readonly DependencyProperty MarginLeftProperty =
            DependencyProperty.Register(nameof(MarginLeft), typeof(double), typeof(ElementPosition));

        public static readonly DependencyProperty MarginRightProperty =
            DependencyProperty.Register(nameof(MarginRight), typeof(double), typeof(ElementPosition));

        public static readonly DependencyProperty SelectorProperty =
            DependencyProperty.Register(nameof(Selector), typeof(Selector), typeof(ElementPosition), new PropertyMetadata(default(Selector), OnSelectorChanged));
        ...
        private static void OnSelectorChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            ...
            var target = obj as ElementPosition;
