...
namespace RoteBridge.Core
{
    ...
    public class FileWatcher
    {
        ...
        private Queue<FileChangeInformation> _queue = null;
        ...
        /// 文件变更信息队列
        /// </summary>
        public Queue<FileChangeInformation> FileChangeQueue
        {
            get
            {
                return _queue;
        ...
        {
            _path = path;
            _queue = new Queue<FileChangeInformation>();
        }
        /// <summary>
        ...
        {
            _path = path;
            _queue = new Queue<FileChangeInformation>(isPersistence, persistenceFilePath);
        }
        ...
        private void OnFileRenamed(object sender, RenamedEventArgs e)
        {
            ...
            {
                //创建消息，并压入队列中
                FileChangeInformation info = new FileChangeInformation(
    ...
    {
        public FileChangeInformation()
        {

        }

        public FileChangeInformation(string id, FileChangeType fileChangeType,
            string oldFullPath, string fullPath, string oldName, string name)
        {
            Id = id;
        ...
        //public bool IsDeletedUtc { get; set; } = false;
        //public bool IsModified { get; set; }
        //public bool IsModifiedUtc { get; set;}
        //public bool IsReadOnly { get; set; }
        //public bool IsReadOnlyUtc { get; set;}
        //public bool IsReadOnlyUtcUtc { get;set;}
        //public bool IsSynchronized { get; set; }
        //public bool IsSynchronizedUtc { get; set;}
    }
