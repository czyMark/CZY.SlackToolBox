...
namespace CZY.SlackToolBox.FastExtend.Communication
{
    ...
    public static class HttpApiTool
    {
        ...
        static IDictionary<string, string> Mappings { get; set; }


        /// <inheritdoc/>
        public static bool GetContentType(this string subpath, out string contentType)
        {
