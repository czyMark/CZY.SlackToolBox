...
using CZY.SlackToolBox.ChatRobot.Imaging.DevControl;
using CZY.SlackToolBox.ChatRobot.Imaging.FunUI;

namespace CZY.SlackToolBox.ChatRobot.Imaging
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            this.InfoNavFun.IsChecked = true;
        ...
        private void ChangePage(string PageName)
        {
            ...
            {
                case "Info":
                    InfoNavFun.IsChecked = true;
                    MainControl.Content = new Home();
                    break;
                case "Mark":
                    MarkNavFun.IsChecked = true;
